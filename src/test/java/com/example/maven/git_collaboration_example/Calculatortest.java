...
public class Calculatortest {
	...
	public void testAddMethod() {
		for (int i = 0; i < 10; i++) {
			...
			assertEquals(c.add(firstNumber, secondNumber),
					result);
		}
	}
	...
	public void testSubtractMethod() {
		for (int i = 0; i < 10; i++) {
			...
			int result = 0;
			result = firstNumber - secondNumber;
			LOG.info("Testing the subtract add with"
					+ firstNumber + " and " + secondNumber);
			assertEquals(
					c.subtract(firstNumber, secondNumber),
					result);
		}
	}
	...
	public void testMultiplyMethod() {
		for (int i = 0; i < 10; i++) {
			...
			int result = 0;
			result = firstNumber * secondNumber;
			LOG.info("Testing the mulitiply add with"
					+ firstNumber + " and " + secondNumber);
			assertEquals(
					c.multiply(firstNumber, secondNumber),
					result);
		}
	}
	...
	public void testDivideMethod() {
		...
		for (int i = 0; i < 100; i++) {
			...
			LOG.info("Testing the method divide with: "
					+ firstNumber + " and " + secondNumber);
			assertEquals(
					Math.round(c.divide(firstNumber,
							secondNumber)),
					Math.round(result), 1);
	...
	public void testSquareMethod() {
		for (int i = 0; i < 10; i++) {
			...
			LOG.info("Testing the square with" + firstNumber
					+ " and " + firstNumber);
	...
	public void testCubeMethod() {
		for (int i = 0; i < 10; i++) {
			...
			result = firstNumber * firstNumber
					* firstNumber;
			LOG.info("Testing the cube with" + firstNumber);
	...
	public void testareaOfCircleMethod() {
		for (int i = 0; i < 10; i++) {
			...
			LOG.info("Testing the areaOfCircle with" + base
					+ " and " + height);
			assertEquals(c.areaOfCircle(base, height),
					result);
		}
	}
	...
	public void testPercent() {
		...
		for (int i = 0; i < 10; i++) {
			...
			int result = 0;
			result = firstNumber * secondNumber;
			LOG.info("Testing the percent method with"
					+ firstNumber + " and " + secondNumber);
			assertEquals(
					c.multiply(firstNumber, secondNumber),
					result);
